...
## So, what is this?
This is an api coded in node.js that wraps a lot of existent code beautifiers. It's purpose is to be easy to install, use and maintain. You can run it locally to use it on any open source existent IDE ( Atom examples are coming soon! ) or deploy it on a server to use it as a service.
