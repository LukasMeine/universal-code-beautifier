...
global.print = function(file_name, data) {
  request(
    "https://img.shields.io/badge/beautified-" +
      data.trim() +
    ...
    function(error, response, body) {
      fs.writeFile('./application/includes/badge.svg', body, function(err) {
        
        global.response.sendFile(path.resolve('./application/includes/badge.svg'));
